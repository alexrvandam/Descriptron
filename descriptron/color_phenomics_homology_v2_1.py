...
def extract_specimen_hue_features(img_lab, fg_bool):
    ...
    Parameters
    ----------
    img_lab : (H, W, 3) float64 array of L*a*b* values (skimage convention)
...
def process_specimen(fn_gpa, specimen_contour, mean_shape, grid_info,
    ...
    hue_feats = extract_specimen_hue_features(img_lab, fg_bool)
