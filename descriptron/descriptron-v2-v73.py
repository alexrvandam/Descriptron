...
def _update_hide_kp_btn():
    ...
    try:
        ...
        if n == 0 or (n == 1 and point_coords):
            hide_keypoints_btn.config(text="Hide Keypoints", relief=tk.RAISED, bg="#d9d9d9")
...
def run_semi_landmarking_script():
    ...
    alignment_method = tk.StringVar(value='without_reflection')
    ...
    tk.OptionMenu(sf, alignment_method, 'without_reflection', 'with_reflection').grid(
        row=row, column=1, sticky='w', padx=5); row += 1
    ...
    tk.Checkbutton(sf, text="Enable TPS sliding semi-landmarks",
...
# === COMPACT BUTTON RELAYOUT (v68) ===
# 7-column layout: col 0 = group label, cols 1-6 = buttons, col 7 = marmot (row 0)
_r = 0

# Marmot save button — top-right, spanning several rows for visibility
...
marmot_button.grid(row=0, column=7, padx=1, pady=1, rowspan=4, sticky="n")

# Rows 0-1: Navigation + Labeling
_nav_lbl = tk.Label(scrollable_frame, text="NAV", font=("Arial", 7, "bold"), fg="#888", width=4)
_nav_lbl.grid(row=_r, column=0, padx=0, pady=0, sticky="e")
prev_btn.grid(row=_r, column=1, padx=1, pady=1)
next_btn.grid(row=_r, column=2, padx=1, pady=1)
prev_image_button.grid(row=_r, column=3, padx=1, pady=1)
next_image_button.grid(row=_r, column=4, padx=1, pady=1)
label_dropdown.grid(row=_r, column=5, padx=1, pady=1)
apply_label_btn.grid(row=_r, column=6, padx=1, pady=1)
_r += 1
trash_button.grid(row=_r, column=1, padx=1, pady=1)
load_annotations_btn.grid(row=_r, column=2, padx=1, pady=1)
load_labels_btn.grid(row=_r, column=3, padx=1, pady=1)
multi_mask_btn.grid(row=_r, column=4, padx=1, pady=1)
save_unlabeled_btn.grid(row=_r, column=5, padx=1, pady=1)
_r += 1

# Rows 2-3: SAM2 loading + prompting + zoom
_sam_lbl = tk.Label(scrollable_frame, text="SAM2", font=("Arial", 7, "bold"), fg="#888", width=4)
_sam_lbl.grid(row=_r, column=0, padx=0, pady=0, sticky="e")
load_btn.grid(row=_r, column=1, padx=1, pady=1)
load_prompt_btn.grid(row=_r, column=2, padx=1, pady=1)
bbox_button.grid(row=_r, column=3, padx=1, pady=1)
remove_bbox_btn.grid(row=_r, column=4, padx=1, pady=1)
point_label_dropdown.grid(row=_r, column=5, padx=1, pady=1)
point_prompt_btn.grid(row=_r, column=6, padx=1, pady=1)
_r += 1
clear_points_btn.grid(row=_r, column=1, padx=1, pady=1)
apply_points_prompt_btn.grid(row=_r, column=2, padx=1, pady=1)
apply_prompt_btn.grid(row=_r, column=3, padx=1, pady=1)
zoom_in_btn.grid(row=_r, column=4, padx=1, pady=1)
zoom_out_btn.grid(row=_r, column=5, padx=1, pady=1)
_r += 1

# Rows 4-6: Keypoints + Brush + COCO tools
_edit_lbl = tk.Label(scrollable_frame, text="EDIT", font=("Arial", 7, "bold"), fg="#888", width=4)
_edit_lbl.grid(row=_r, column=0, padx=0, pady=0, sticky="e")
keypoint_edit_btn.grid(row=_r, column=1, padx=1, pady=1)
keypoints_to_mask_btn.grid(row=_r, column=2, padx=1, pady=1)
keypoints_to_line_btn.grid(row=_r, column=3, padx=1, pady=1)
hide_keypoints_btn.grid(row=_r, column=4, padx=1, pady=1)
eraser_btn.grid(row=_r, column=5, padx=1, pady=1)
paintbrush_btn.grid(row=_r, column=6, padx=1, pady=1)
reannotate_btn.grid(row=_r, column=7, padx=1, pady=1)
_r += 1
brush_size_menu.grid(row=_r, column=1, padx=1, pady=1)
btn_sam2_pal.grid(row=_r, column=2, padx=1, pady=1)
btn_load_video.grid(row=_r, column=3, padx=1, pady=1)
coco_to_min_btn.grid(row=_r, column=4, padx=1, pady=1)
combine_json_btn.grid(row=_r, column=5, padx=1, pady=1)
remove_files_from_json_btn.grid(row=_r, column=6, padx=1, pady=1)
_r += 1

# Row 7: Detectron2 + Predictions
_det_lbl = tk.Label(scrollable_frame, text="DET2", font=("Arial", 7, "bold"), fg="#888", width=4)
_det_lbl.grid(row=_r, column=0, padx=0, pady=0, sticky="e")
train_button.grid(row=_r, column=1, padx=1, pady=1)
predict_btn.grid(row=_r, column=2, padx=1, pady=1)
view_predictions_btn.grid(row=_r, column=3, padx=1, pady=1)
select_prediction_btn.grid(row=_r, column=4, padx=1, pady=1)
category_label_dropdown.grid(row=_r, column=5, padx=1, pady=1)
apply_category_label_btn.grid(row=_r, column=6, padx=1, pady=1)
_r += 1

# Rows 8-9: Analysis pipeline + Species Delimitation
_pipe_lbl = tk.Label(scrollable_frame, text="PIPE", font=("Arial", 7, "bold"), fg="#888", width=4)
_pipe_lbl.grid(row=_r, column=0, padx=0, pady=0, sticky="e")
measure_button.grid(row=_r, column=1, padx=1, pady=1)
semilandmark_button.grid(row=_r, column=2, padx=1, pady=1)
color_segmentation_button.grid(row=_r, column=3, padx=1, pady=1)
texture_phenomics_button.grid(row=_r, column=4, padx=1, pady=1)
texture_homology_button.grid(row=_r, column=5, padx=1, pady=1)
color_homology_button.grid(row=_r, column=6, padx=1, pady=1)
_r += 1
try:
    _btn_species_delim.grid(row=_r, column=1, padx=1, pady=1)
except NameError:
    pass
btn_dinoland.grid(row=_r, column=2, padx=1, pady=1)
_r += 1

# Row 10: Ontology + BioRAG + Zenodo
_out_lbl = tk.Label(scrollable_frame, text="OUT", font=("Arial", 7, "bold"), fg="#888", width=4)
_out_lbl.grid(row=_r, column=0, padx=0, pady=0, sticky="e")
if _ONTOLOGY_AVAILABLE:
    btn_load_template.grid(row=_r, column=1, padx=1, pady=1)
    btn_import_gbif.grid(row=_r, column=2, padx=1, pady=1)
    btn_export_enhanced.grid(row=_r, column=3, padx=1, pady=1)
    btn_export_kg.grid(row=_r, column=4, padx=1, pady=1)
btn_biorag.grid(row=_r, column=5, padx=1, pady=1)
btn_delimit.grid(row=_r, column=7, padx=1, pady=1)
btn_zenodo.grid(row=_r, column=6, padx=1, pady=1)
_r += 1
...
btn_treatment_docx.grid(row=_r, column=1, padx=1, pady=1)
