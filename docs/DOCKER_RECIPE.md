...
**Linux:**
    ...
    docker run --rm --user "$(id -u):$(id -g)" \
      ...
      ghcr.io/alexrvandam/descriptron:2.0.1 pipeline \
...
## 6. Other commands
    ...
    docker run --rm ghcr.io/alexrvandam/descriptron:2.0.1 help
    docker run --rm ghcr.io/alexrvandam/descriptron:2.0.1 pipeline --help
