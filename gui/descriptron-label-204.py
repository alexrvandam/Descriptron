...
def run_coco_converter_script():
    ...
    def submit():
        ...
        script_dir = Path(__file__).parent  # Directory where the GUI script is located
        converter_script = script_dir / 'coco_converter_v3.py'
    ...
    tk.Button(input_window, text="Run", command=submit).grid(row=4, column=1, sticky='e', padx=5, pady=10)
    tk.Button(input_window, text="Cancel", command=input_window.destroy).grid(row=4, column=2, sticky='w', padx=5, pady=10)
