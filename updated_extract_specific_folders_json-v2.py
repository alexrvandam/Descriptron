...
image_directory = config['Paths']['image_directory']  # specific_folder_of_subset_of_test_data
...
for pred in predictions:
    if pred["file_name"] in specific_images:
        ...
        via2_data["_via_img_metadata"][f"{file_data['filename']}#${file_data['size']}"] = file_data
        image_id += 1
